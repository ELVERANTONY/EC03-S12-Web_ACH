...
public class LoggingAspect {
     ...
     */
    @Before("execution(* com.cholan.edu.ev12_cholan.service.*.*(..))")
     ...
     */
    @AfterReturning(pointcut = "execution(* com.cholan.edu.ev12_cholan.service.*.*(..))", 
                    returning = "result")
     ...
     */
    @AfterThrowing(pointcut = "execution(* com.cholan.edu.ev12_cholan.service.*.*(..))", 
                   throwing = "exception")
     ...
     */
    @Around("execution(* com.cholan.edu.ev12_cholan.service.*.*(..))")
     ...
     */
    @Before("execution(* com.cholan.edu.ev12_cholan.controller.*.*(..))")
