package com.cholan.edu.ev12_cholan.aspect;
...
public class AuditoriaAspect {
     ...
     */
    @AfterReturning(pointcut = "execution(* com.cholan.edu.ev12_cholan.service.*.save*(..)) || " +
                               "execution(* com.cholan.edu.ev12_cholan.service.*.create*(..))", 
                    returning = "result")
     ...
     */
    @AfterReturning(pointcut = "execution(* com.cholan.edu.ev12_cholan.service.*.update*(..))", 
                    returning = "result")
     ...
     */
    @AfterReturning(pointcut = "execution(* com.cholan.edu.ev12_cholan.service.*.delete*(..)) || " +
                               "execution(* com.cholan.edu.ev12_cholan.service.*.remove*(..))", 
                    returning = "result")
